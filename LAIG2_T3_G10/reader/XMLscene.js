...
XMLscene.prototype.initLights = function () {	
	...
	for (var j = 0; j < this.graph.spots.length; j++, lix++) {
        var spt = this.graph.spots[j];       
        
        this.lights[2].setPosition(spt.location.x, spt.location.y, spt.location.z, 1);
        this.lights[2].setAmbient(spt.ambient.r, spt.ambient.g, spt.ambient.b, spt.ambient.a);
        this.lights[2].setDiffuse(spt.diffuse.r, spt.diffuse.g, spt.diffuse.b, spt.diffuse.a);
        this.lights[2].setSpecular(spt.specular.r, spt.specular.g, spt.specular.b, spt.specular.a);
        this.lights[2].setSpotDirection(spt.direction.x, spt.direction.y, spt.direction.z);
        this.lights[2].setSpotExponent(spt.exponent);
        this.lights[2].setSpotCutOff(spt.angle*deg2rad);
        ...
        this.laux.push(bul);
        this.myInterface.addLight(lix,spt.id);
    }
...
XMLscene.prototype.initPrimitives = function() {
	...
	for( var i = 0; i < this.graph.primitives.length; i++) {
		...
		case "vehicle":
			...
			break;
		case "chessboard":
			var obj = new ChessBoard(this, primitive.args);
			obj.id = primitive.id;
			this.primitives.push(obj);
			break;
		}
...
/**
 * @returns {SceneMaterial} with the {list} ids specified 
 */
