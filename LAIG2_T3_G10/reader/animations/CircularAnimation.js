function CircularAnimation(id, time, centerx, centery, centerz, rad, iang, rang) {
...
CircularAnimation.prototype.update = function(delta) {
    ...
    mat4.translate(this.matrix, this.matrix, vec3.fromValues(this.centerx, this.centery, this.centerz));
